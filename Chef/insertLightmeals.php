...
?>
   ...
   else
   {
	...
	$price = $_POST['price'];
     ...
     $sql="INSERT INTO insertLightmeals (name, image,price) VALUES ('$name','$file','$price')";
	...
	<?php
	$display = mysqli_query($conn, "select * from insertLightmeals");
	while($row = mysqli_fetch_array($display)){
		...
		<?php
				 ...
				 <div class="row">
				 <form enctype="multipart/form-data" action="insertLightmeals.php" method="post" name="changer">
