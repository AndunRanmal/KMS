            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li class="active-link">
                        <a href="users.html" ><i class="fa fa-desktop "></i>Profile <!-- <span class="badge">Included</span> --></a>
                        <img src="assets/img/girl.jpg"  class="img-circle" height="200px" width="250px" style="padding-bottom: 15px;
    padding-left: 15px;">
                    </li>
