        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="purreq.html"><i class="fa fa-edit "></i>Purchase Requision </a>
                    </li>
                    ...
                    <li>
                        <a href="charttype1.php"><i class="fa fa-bar-chart-o"></i>charts</a>
                    </li>

                    <li>
                        <a href="compareyear.php"><i class="fa fa-edit "></i>compare year</a>
                    </li>
                    <li>
                    ...
                    <div class="row text-center pad-top">
                  		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                            ...
                            <a href="blank.html" id="trigger">
 							<i class="fa fa-circle-o-notch fa-5x" style="color: #00bfff;"></i>
